        ...
        <GridContainer>
            ...
            <Card plain>
              ...
              <CardBody>
                <p className={classes.description}>
                  ...
                  poverty and find victory in their lives.{" "}
                </p>
              </CardBody>
            </Card>
          </GridItem>
          <GridItem xs={12} sm={12} md={4}>
            <Card plain>
              ...
              <CardBody>
                <p className={classes.description}>
                  Our Vision is to bring God's victory and kingdom in the Katy,
                  TX area by working with local churches and non-profits.
                </p>
              </CardBody>
            </Card>
          </GridItem>
